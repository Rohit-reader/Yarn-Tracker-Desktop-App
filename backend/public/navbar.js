    ...
    <nav id="app-navbar">
        ...
        <div class="nav-links">
            ...
            <a href="/testing.html" class="nav-item ${currentPage === 'testing.html' ? 'active' : ''}">
                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 4a2 2 0 114 0v1a2 2 0 012 2v1a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2V4a2 2 0 114 0v1a2 2 0 012 2v1"></path></svg>
                QR for Testing
            </a>
        </div>
